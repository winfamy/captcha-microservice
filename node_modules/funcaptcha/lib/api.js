...
function getToken(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let res = yield (0, http_1.default)(options.surl, {
            ...
            body: util_1.default.constructFormData(Object.assign({ bda: util_1.default.getBda(ua), public_key: options.pkey, site: options.site, userbrowser: ua, rnd: Math.random().toString(), language: "en" }, Object.fromEntries(Object.keys(options.data).map(v => ["data[" + v + "]", options.data[v]])))),
